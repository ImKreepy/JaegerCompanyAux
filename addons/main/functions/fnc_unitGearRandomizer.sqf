...
/*
 * Authors: Im Kreepy
 * Randomizes a unit's vest and headgear as a kit.
 *
 * Arguments:
 * 0: _unit <OBJECT>
 ...
 *
 * Example:
 * [(_this select 0), [["vest1","headgear1"], ["vest2","headgear2"]]] call jc_main_fnc_unitGearRandomizer
 *
 * Public: No
 */
...
private _randomGear = selectRandom _gearList;
