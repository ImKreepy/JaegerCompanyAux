class JC_H5_HaloCanticles
{
    ...
    theme="JC_Halo5_Tracks";
    duration="253";
    musicClass="JC_Halo5_Tracks";
};
class JC_H5_LightIsGreen
{
    name="Light Is Green";
    sound[]=
    {
...
class JC_H5_UnconfirmedReports
{
