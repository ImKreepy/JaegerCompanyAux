class JC_HW2_Recommissioned
{
    ...
    theme="JC_HaloWars2_Tracks";
    duration="119";
    musicClass="JC_HaloWars2_Tracks";
};
class JC_HW2_Barren
{
    name="Barren";
...
class JC_HW2_BonVoyageBonChance
{
...
class JC_HW2_SteelHandsGlovesOff
{
...
class JC_HW2_CatastrophicFailure
{
...
class JC_HW2_LegitimateStrategy
{
