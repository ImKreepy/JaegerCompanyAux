class JC_HR_Overture
{
    ...
    theme="JC_HaloReach_Tracks";
    duration="268";
    musicClass="JC_HaloReach_Tracks";
};
class JC_HR_WinterContingency
{
...
class JC_HR_WereNotGoingAnywhere
{
