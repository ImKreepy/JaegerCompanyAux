class JC_HW_SpiritOfFire
{
    ...
    theme="JC_HaloWars_Tracks";
    duration="131";
    musicClass="JC_HaloWars_Tracks";
};
class JC_HW_BadHereDay
{
    name="Bad Here Day";
    sound[]=
    {
...
class JC_HW_SixArmedRobbingSuite
{
...
class JC_HW_WorkBurnsAndRunawayGrunts
{
...
class JC_HW_FingerprintsAreBroken
{
...
class JC_HW_WereBurningSunshine
{
