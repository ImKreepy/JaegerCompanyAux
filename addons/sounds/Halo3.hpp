class JC_H3_Luck
{
	...
	theme="JC_Halo3_Tracks";
	duration="195";
	musicClass="JC_Halo3_Tracks";
};
class JC_H3_Released
{
	name="Released";
	sound[]=
	{
...
class JC_H3_HonorableIntentions
{
...
class JC_H3_WakeMeWhenYouNeedMe
{
