class JC_H2A_ThemeGungnirMix
{
    ...
    theme="JC_Halo2A_Tracks";
    duration="254";
    musicClass="JC_Halo2A_Tracks";
};
class JC_H2A_Skyline
{
    name="Skyline";
    sound[]=
    {
...
class JC_H2A_UnforgottenMemories
{
...
class JC_H2A_ThisGlitteringBand
{
...
class JC_H2A_BreakingTheCovenant
{
...
class JC_H2A_MenaceNoMore
{
	name="Menace No More";
	sound[]=
	{
		"JC_Music\data\Halo2A\Halo 2 Anniversary OST - CD2 - 17 Menace No More.ogg",
		1,
		1
	};
	theme="JC_Halo2A_Tracks";
