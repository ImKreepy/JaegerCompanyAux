class JC_HCE_OpeningSuite
{
    ...
    theme="JC_HaloCE_Tracks";
    duration="191";
    musicClass="JC_HaloCE_Tracks";
};
class JC_HCE_TruthAndReconciliation
{
...
class JC_HCE_TheGunPointedAtTheHead
{
...
class JC_HCE_UnderCoverOfNight
{
...
class JC_HCE_RockAnthemForSaving
{
...
class JC_HCE_HaloCEUnreleased_PompCircumstances
{
