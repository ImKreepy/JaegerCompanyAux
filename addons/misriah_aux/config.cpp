...
class CfgPatches {
    class ADDON {
        ...
        requiredAddons[] = {"jc_main","MA_Armor"};
...
class CfgVehicles
{
    ...
    //Marine Gear
    #include "data/Marine/Unit.hpp"

    //ODST Gear
    #include "data/ODST/Unit.hpp"
    #include "data/ODST/Backpack.hpp"
};
...
class CfgWeapons
{
    ...
    #include "data/Marine/pouchesReqs.hpp"

    //Marine Gear
    #include "data/Marine/Vest.hpp"
    #include "data/Marine/Headgear.hpp"
    #include "data/Marine/Uniform.hpp"

    //ODST Gear
    #include "data/ODST/Vest.hpp"
    #include "data/ODST/Headgear.hpp"
    #include "data/ODST/Uniform.hpp"
};
