class IK_MA_odstHeadgear_Kodiak : IK_MA_odstHeadgear
{
	class XtdGearInfo
	{
	...
	displayName = ITEM_NAME(Kodiak ODST Helmet);
	hiddenSelectionsTextures[] =
	{
		QPATHTOF(data\ODST\Kodiak\MA_ODST_Helmet_co.paa),
...
class IK_MA_odstHeadgear_Kodiak_dp : IK_MA_odstHeadgear_Kodiak
{
	scope = 1;
	scopeArsenal = 1;
