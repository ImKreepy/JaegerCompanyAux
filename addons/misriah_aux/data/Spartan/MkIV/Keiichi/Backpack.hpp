class IK_MAPO_KeiichiBackpack : IK_MAPO_spartanBackpack
{
    ...
    hiddenSelectionsTextures[] =
    {
        ...
        "MA_Armor\data\Vests\MKVB\Shoulders\JFO\Olive_JFO_Shoulders_CO.paa",
        QPATHTOF(data\Spartan\MkIV\Keiichi\MKIV_Shoulders_co.paa), //MkIV Shoulder Left
        QPATHTOF(data\Spartan\MkIV\Keiichi\MKIV_Shoulders_co.paa),  //MkIV Shoulder Right
